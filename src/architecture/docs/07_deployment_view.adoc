...
===== Compute (Physical / Virtual / Container)

.Compute (Physical / Virtual / Container)
[width="100%",cols="15%,15%,15%,10,10,10,10,15",options="header",]
|===
|*Host* |*App* |*OS* |*CPU* |*Mem* |*Disk* |*DC* |*Type*
|       |       |       |      |      |      |      |
|===   

===== Databases

.Database Servers (Physical / Virtual)
[width="100%",cols="15%,15%,15%,10,10,10,10,15",options="header",]
|===
|*Host* |*DB* |*OS* |*CPU* |*Mem* |*Disk* |*DC* |*Type*
|       |       |       |      |      |      |      |
|===   
